...
Open CLion, select **CS370_Fa23** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab01** subdirectory). Uncomment the line
...
Download [CS370\_Lab01\_Solution.zip](sol/CS370_Lab01_Solution.zip), saving it into the **CS370_Fa23** directory.
...
Open CLion, select **CS370_Fa23** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab01\_Solution** subdirectory). Uncomment the line
